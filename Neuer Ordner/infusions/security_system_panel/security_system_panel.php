...
echo "<div style='color:#c00000;' align='center'><b>Die maincore.php wurde ge&auml;ndert!<br>Bitte f&uuml;ge das Security System lt. Online Dokumentation wieder ein.<hr>The maincore.php was modify.<br>Please read the online documentation and modify your maincore.php again!</b></div>";
}
else {
...
$proxy_login=$counts['proxy_login'];
  ...
  <img src='".INFUSIONS."security_system/images/bs_mini.jpg' border='0' alt='Security System ".$sys_version." &copy; 2006-2008 by BS-Fusion Deutschland' title='Security System ".$sys_version." &copy; 2006-2008 by BS-Fusion Deutschland' /></a>";
  $secsys_miniimg = "<a class='small' href='http://www.bs-fusion.de' target='_blank'>
  <img src='" . INFUSIONS."security_system/images/small_security_logo.jpg' border='0' alt='Security System ".$sys_version." &copy; 2006-2008 by BS-Fusion Deutschland' title='Security System ".$sys_version." &copy; 2006-2008 by BS-Fusion Deutschland' /></a>";
  $secsys_minipic2 = "<a class='small' href='http://www.bs-fusion.de' target='_blank'>
  <img src='".INFUSIONS."security_system/images/secure_mini.gif' border='0' alt='Security System ".$sys_version." &copy; 2006-2008 by BS-Fusion Deutschland' title='Security System ".$sys_version." &copy; 2006-2008 by BS-Fusion Deutschland' /></a>";
