...
opentable($locale['SYS100']." ".$license['version']);
    ...
    echo "
    <tr>
        <td rowspan='4' width='25%' class='tbl2' align='center'><a class='small' href='".ADMIN."index.php".$ins_aidlink."'><b>".$locale['SYS170']."</b></a></td>
        <td width='25%' class=".($sys_page == "overview" ? "'tbl1'" : "'tbl2'")." align='center'><span class='small'>".($sys_page == "overview" ? "<b>".$locale['SYS105']."</b>" : "<a class='small' href='".FUSION_SELF."?pagefile=overview'><b>".$locale['SYS105']."</b></a>")."</span></td>
