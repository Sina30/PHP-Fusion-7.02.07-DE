...
$hack_type=!isset($_GET['hack_type'])?'overview':stripinput($_GET['hack_type']);
...
$list.="<center>$sys_error</center>
<table cellspacing='1' cellpadding='2' width='100%' border='1px' style='font-size:10px;'>
<tr class='tbl2'>
...
$background='tbl1';
  while($row=dbarray($result)) {
   ...
   <td valign='top'>".wordwrap($row['hack_query'],20,'<br />')."</td>
   <td valign='top'>".wordwrap($row['hack_referer'],20,"<br />")."&nbsp;</td>
   <td valign='top'>".wordwrap($row['hack_agent'],20,'<br />')."</td>
   </tr>\n";
   $listnum++;
  }
$list.="</table>";
