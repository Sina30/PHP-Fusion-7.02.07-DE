...
$stat='<center><form action="https://www.paypal.com/cgi-bin/webscr" method="post"><b><span style="color:red;">Eine Spende f&uuml;r dieses Projekt w&uuml;rde uns freuen und wir w&auml;ren daf&uuml;r sehr dankbar.<br />
...
<tr><td class='tbl2'><b>".$locale['SYS118'].":</b></td>
<td class='tbl2'><b>".sprintf($locale['SYS302'],($stats['blocks']+$stats['hacks']+$stats['floods']+$stats['spams']+$stats['proxy_login']+$stats['proxy_register']+$stats['proxy_visit']+$stats['proxy_blacklist']))."</b></td></tr>
</table>
<br /><br />
<form action='".FUSION_SELF."?pagefile=logfiles&amp;action=update_system' method='post'>
