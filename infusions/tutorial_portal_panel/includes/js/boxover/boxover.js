...
function defHdrStyle() {
	...
	dvHdr.style.border='1px solid #ededed';
	dvHdr.style.padding='5px';
	dvHdr.style.fontSize='12';
	dvHdr.style.color='#000000';
	dvHdr.style.background='#e1e1e1';
	dvHdr.style.filter='alpha(opacity=85)'; // IE
	dvHdr.style.opacity='0.85'; // FF
}

function defBdyStyle() {
	dvBdy.style.borderBottom='1px solid #ededed';
	dvBdy.style.borderLeft='1px solid #ededed';
	dvBdy.style.borderRight='1px solid #ededed';
