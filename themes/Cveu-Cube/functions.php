...
set_image("hot", THEME."forum/hot.png");
set_image("poll_posticon", THEME."forum/poll_posticon.png");
set_image("attach", THEME."forum/attach.png");
set_image("image_attach", THEME."forum/image_attach.png");
