...
global $userdata, $settings, $aidlink;
	...
	echo"<div id='top-navi' width='100%'>
	<div class='active-linkage'>
   ...
   $msg_count = dbcount("(message_id)", DB_MESSAGES, "message_to='".$userdata['user_id']."' AND message_read='0'AND message_folder='0'");
   if($msg_count){
   echo '<center><table class="box1PN"  align="center" cellpadding="0" cellspacing="0"><tr><td align="center">'; 
   echo "<img src='".THEME."images/pn.png' alt='Punkte' width='12' height='12' style='vertical-align: middle;' /> <a href='".BASEDIR."messages.php' class='side'>Du hast <b>".sprintf("%u " , $msg_count)."</b> neue ".($msg_count == 1 ? $locale['global_126'] : $locale['global_127'])."</a> <img src='".THEME."images/pn.png' alt='Punkte' width='12' height='12' style='vertical-align: middle;' />";
   ...
   //echo '<br>';
	...
	<a href='".BASEDIR."members/members.php' class='side'><li class='members'>".$locale['global_122']."</li></a>\n";
