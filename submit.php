...
if ($_GET['stype'] == "l") {
	if (isset($_POST['submit_link'])) {
		...
		if (dbrows($result)) {
			...
			echo "<div class='tbl'>".$locale['420']."</div>\n";
			...
			echo "<tr><td class='tbl'>".$locale['421'].":</br><select name='link_category' class='textbox'>\n$opts</select></td>";
			echo "<td class='tbl'>".$locale['422'].":</br><input type='text' name='link_name' maxlength='100' class='textbox' style='width:280px;' /></td></tr>";
			echo "<td class='tbl'>".$locale['423'].":</br><input type='text' name='link_url' value='http://' maxlength='200' class='textbox' style='width:280px;' />";
			echo "</td>";
			echo "<td class='tbl'>".$locale['424'].":</br><input type='text' name='link_description' maxlength='200' class='textbox' style='width:300px;' />";
			echo "</td></tr>";
	...
	if (isset($_POST['submit_news'])) {
		...
		add_to_title($locale['global_200'].$locale['450']);
		opentable($locale['450']);
		echo "<div class='tbl'>".$locale['470']."</div>\n";
		echo "<table class='tbl-border table table-responsive' border='0' width='100%' align='center'>";
		echo "<tr><td class='tbl'>".$locale['471'].":</br><input type='text' name='news_subject' value='$news_subject' maxlength='64' class='textbox' style='width:280px;' /></td>";
		echo "<td class='tbl'>".$locale['476'].":</br><select name='news_cat' class='textbox'>\n<option value='0'>".$locale['477']."</option>\n".$cat_list."</select></td></tr>";
		echo "<td class='tbl'>".$locale['478'].":</br><textarea name='news_snippet' cols='60' rows='8' class='textbox dummy_classname' style='width:280px;'>$news_snippet</textarea>";
		echo display_bbcodes("150%", "news_snippet", "submit_form", "b|i|u|center|small|url|mail|img|color");
		echo "</td>";
		echo "<td class='tbl'>".$locale['472'].":</br><textarea name='news_body' cols='60' rows='8' class='textbox dummy_classname' style='width:280px;'>$news_body</textarea>";
	...
	if (isset($_POST['submit_article'])) {
		...
		if (dbrows($result)) {
			...
			echo "<div class='tbl'>".$locale['520']."</div>\n";
		echo "<form name='submit_form' method='post' action='".FUSION_SELF."?stype=a' onsubmit='return validateArticle(this);'>\n";
		echo "<table class='tbl-border table table-responsive' border='0' width='100%' align='center'>";
		echo "<tr><td class='tbl'>".$locale['521'].":</br><select name='article_cat' class='textbox'>\n$cat_list</select></td>";
		echo "<td class='tbl'>".$locale['522'].":</br><input type='text' name='article_subject' value='$article_subject' maxlength='64' class='textbox dummy_classname' style='width:280px;' /></td></tr>";
		echo "<td class='tbl'>".$locale['523'].":</br><textarea name='article_snippet' cols='60' rows='3' class='textbox dummy_classname' style='width:280px;'>$article_snippet</textarea>";
		echo display_bbcodes("100%", "news_snippet", "submit_form", "b|i|u|center|small|url|mail|img|color");
		echo "</td>";
		echo "<td class='tbl'>".$locale['524'].":</br><textarea name='article_body' cols='60' rows='8' class='textbox dummy_classname' style='width:280px;'>$article_body</textarea>";
		echo display_bbcodes("100%", "news_snippet", "submit_form", "b|i|u|center|small|url|mail|img|color");
		echo "</td></tr>";
		echo "<td align='center' colspan='2' class='tbl'><br /><br />\n";
	...
	if (isset($_POST['submit_photo'])) {
		...
		if (dbrows($result)) {
			...
			echo "<div class='tbl'>".$locale['620']."</div>\n";
		...
		echo "<table class='tbl-border table table-responsive' border='0' width='100%' align='center'>";
		echo "<tr><td class='tbl'>".$locale['621'].":</br><input type='text' name='photo_title' maxlength='100' class='textbox' style='width:250px;' /></td>";
		echo "<td class='tbl'>".$locale['622'].":</br><textarea name='photo_description' cols='60' rows='5' class='textbox' style='width:300px;'></textarea></td></tr>";
		echo "<td class='tbl'>".$locale['623'].":</br><label><input type='file' name='photo_pic_file' class='textbox' style='width:250px;' /><br />";
		echo "".sprintf($locale['624'], parsebytesize($settings['photo_max_b']), $settings['photo_max_w'], $settings['photo_max_h'])."</label>\n";
		echo "</td>";
		echo "<td class='tbl'>".$locale['625'].":</br><select name='album_id' class='textbox'>\n$opts</select>";
		echo "</td></tr>";
		echo "<td align='center' colspan='2' class='tbl'><br /><br />\n";
	...
	if (isset($_POST['submit_download'])) {
		...
		echo "<div class='tbl'>".$locale['680']."</div>\n";
		...
		echo "<table class='tbl-border table table-responsive' border='0' width='100%' align='center'>";
		echo "<tr><td class='tbl'>".$locale['681']."</br><input type='text' name='download_title' class='textbox' style='width:380px;' /></td>";
		echo "<td class='tbl'>".$locale['682b']."<span id='shortdesc_display' style='padding: 1px 3px 1px 3px; border:1px solid; display:none;'><strong>255</strong></span></br>";
		echo "<textarea name='download_description_short' cols='60' rows='4' class='textbox' style='width:380px;' onKeyDown=\"shortdesc_counter(this,'shortdesc_display',255);\" onKeyUp=\"shortdesc_counter(this,'shortdesc_display',255);\"></textarea></td></tr>\n";
		echo "<td class='tbl'>".$locale['682']."</br><textarea name='download_description' cols='60' rows='5' class='textbox' style='width:380px;'></textarea>";
		require_once INCLUDES."bbcode_include.php";
		echo display_bbcodes("100%", "download_description", "submit_form")."</td>\n";
		echo "</td>";
		echo "<td class='tbl'>".$locale['683']."</br><input type='text' name='download_url' class='textbox' style='width:380px;' />";
		echo "</td></tr>";
		echo "</tr>\n</table>\n</form>\n";
		echo "<table class='tbl-border table table-responsive' border='0' width='100%' align='center'>";
		echo "<tr><td class='tbl'>".$locale['684']."<span style='color:#0000cc'>*</span></br>\n";
		...
		echo "</td>\n";
		echo "<td class='tbl'>".$locale['686']."</br>";
		echo "<input type='file' name='download_image' class='textbox' style='width:280px;' /><br />\n";
		...
		echo "</tr>\n</table>\n</form>\n";
		echo "<table class='tbl-border table table-responsive' border='0' width='100%' align='center'>";
		echo "<tr><td class='tbl'>".$locale['687']."</br><select name='download_cat' class='textbox'>\n".$opts."</select></td>";
		echo "<td class='tbl'>".$locale['688']."</br><input type='text' name='download_license' class='textbox' style='width:150px;' /></td></tr>";
		echo "<tr><td class='tbl'>".$locale['689']."</br><input type='text' name='download_os' class='textbox' style='width:150px;' /></td>";
		echo "<td class='tbl'>".$locale['690']."</br><input type='text' name='download_version' class='textbox' style='width:150px;' /></td></tr>";
		echo "<td class='tbl'>".$locale['691']."</br><input type='text' name='download_homepage' class='textbox' style='width:150px;' /><br />";
		echo "</td>";
		echo "<td class='tbl'>".$locale['692']."</br><input type='text' name='download_copyright' class='textbox' style='width:150px;' />";
		echo "</td></tr>";
		echo "</tr>\n</table>\n</form>\n";			
		echo "<table class='tbl-border table table-responsive' border='0' width='100%' align='center'>";
		echo "<tr><td class='tbl'>".$locale['693']."</br><input type='text' name='download_filesize' id='download_filesize' class='textbox' style='width:150px;' /></td>";
		echo "</td></tr>";
