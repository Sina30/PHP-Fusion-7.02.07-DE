...
class UserFields {
	...
	private function renderBasicInputFields() {
		...
		if (!$this->skipCurrentPass) {
			$this->html .= $this->basicInputField("user_password", $locale['u133'], "30", "", "password", false, "user_password");
		}
		$this->html .= $this->basicInputField("user_new_password", ($this -> registration == TRUE ? $locale['u133'] : $locale['u134']), "30", $passRequired, "password", false, "user_password");
		$this->html .= "<tr>\n<td class='tbl'></td>\n<td class='tbl'><span class='small2'>".$locale['u147']."</span></td>\n</tr>\n";
		$this->html .= $this->basicInputField("user_new_password2", $locale['u135'], "30", $passRequired, "password", false, "user_password");
		...
		if ($this->showAdminPass && iADMIN) {
			...
			if ($this->userData['user_admin_password']) {
				$this->html .= $this->basicInputField("user_admin_password", $locale['u131'], "30", "", "password", false, "user_admin_password");
			}
			$this->html .= $this->basicInputField("user_new_admin_password", ($this -> userData['user_admin_password'] ? $locale['u144'] : $locale['u131']), "30", "", "password", false, "user_admin_password");
			$this->html .= "<tr>\n<td class='tbl'></td>\n<td class='tbl'><span class='small2'>".$locale['u147']."</span></td>\n</tr>\n";
			$this->html .= $this->basicInputField("user_new_admin_password2", $locale['u145'], "30", "", "password", false, "user_admin_password");
		}

		// Hide email
		$this->html .= "<tr>\n<td colspan='2' class='profile_category_name tbl2'><strong>".$locale['u129']."</strong></td></tr>\n";
		$this->html .= (iADMIN || $this->_userNameChange ? $this->basicInputField("user_name", $locale['u127'], "12", $locale['u122']) : "");
		$this->html .= "<tr>\n<td class='tbl'></td>\n<td class='tbl'><span class='small2'>".$locale['403a']."</span></td>\n</tr>\n";
