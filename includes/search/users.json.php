...
$q = $_GET['q'];
$result = dbquery("SELECT user_id, user_name, user_avatar, user_level FROM ".DB_USERS." WHERE user_status='0' AND user_name LIKE '$q%' ORDER BY user_level DESC, user_name ASC");
