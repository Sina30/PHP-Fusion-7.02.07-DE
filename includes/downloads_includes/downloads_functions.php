         ...
         $license = $data['download_license'];
            ...
            if ($agpl === false && $gnu === false) {
             $license_colorbox_output = "<div class='license-message' style='margin-top: 20px; margin-bottom: 5px;'> ".$locale['429c'].$data['download_license']."<div style='float: right; margin-top: 2px;'>\n</div>\n</div></a>";
               ...
               $license_colorbox_output = "<a class='tozoomb' href='".BASEDIR."includes/downloads_includes/agpl.html'><div class='license-message' style='margin-top: 20px; margin-bottom: 5px;'><strong>Lizenz- Bitte lesen</strong><div style='float: right; margin-top: 2px;'>\n</div>\n</div></a>";
   }
