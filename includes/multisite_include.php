...
// Admin Pro Definitions

define("DB_ADMINVISIT", DB_PREFIX."admin_visit");

define("DB_ADMINPANELS", DB_PREFIX."admin_panels");

define("DB_ADMINOPTIONS", DB_PREFIX."admin_options");
