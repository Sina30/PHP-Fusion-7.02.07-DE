...
function opensetup() {
	...
	echo "<link href='dynamics/dynamics.inc.php' />";
	echo "</head>\n<body>\n";
...
if (!isset($_POST['step']) || $_POST['step'] == "" || $_POST['step'] == "3") {	
echo "</div>\n";
	echo "</div>\n";
	echo "<!--button -->\n";
	echo "<div class='text-right'>\n";
...
if (!isset($_POST['step']) || $_POST['step'] == "" || $_POST['step'] == "4") {	
echo "</div>\n";
	echo "</div>\n";
	echo "<!--button -->\n";
	echo "<div class='text-right'>\n";
...
if (!isset($_POST['step']) || $_POST['step'] == "" || $_POST['step'] == "5") {	
echo "</div>\n";
	echo "</div>\n";
	echo "<!--button -->\n";
	echo "<div class='text-right'>\n";
...
if (!isset($_POST['step']) || $_POST['step'] == "" || $_POST['step'] == "6") {	
echo "</div>\n";
	echo "</div>\n";
	echo "<!--button -->\n";
	echo "<div class='text-right'>\n";
...
if (!isset($_POST['step']) || $_POST['step'] == "" || $_POST['step'] == "1") {
	...
	echo "<h4 class='strong'>".$locale['501']."</h4><br />";
	echo "<span>".$locale['setup_0003']."</span><br /><br />";
	echo "<span>".$locale['504']."</span><br />";
	echo "<span class='display-block m-t-20 m-b-10 strong'>".$locale['010']."</span>\n";
	echo "<select name='localeset' class='select2-container' style='margin-top:5px'>\n";
	echo $locale_list."</select><br /><br />\n";
	echo $locale['011']."<br /><br />\n";

	
echo'	
<form action="#.html" > 
  <label for="check1"><input  type="radio" id="agb" name="agb" value="ok" id="check1" onclick="weiter();">'.$locale["setup_0005"].'</label><br> 
  <label for="check2"><input type="radio" name="agb" id="abl" checked value="no" id="check2" onclick="weiter();"> Ich lehne die AGBs ab</label>
 
  <fieldset id="persAngaben" disabled>';
	echo "<div class='text-right'>\n";
	echo' <button type="radio" name="next" value="$locale" class="btn btn-primary" /><i class="entypo right-dir"></i>'.$locale['007'].'</button>';
 echo' </fieldset>
</form>
...
if (isset($_POST['step']) && $_POST['step'] == "4") {
	...
	$result = dbquery("CREATE TABLE ".$db_prefix."admin_panels (
		...
		panel_order int(2) unsigned NOT NULL,
		panel_side int(2) unsigned NOT NULL,
		panel_file varchar(255) NOT NULL,
		panel_display tinyint(1) unsigned NOT NULL default '0',
		PRIMARY KEY (panel_id)
		) ENGINE=MYISAM;");
	if (!$result) {
	...
	$result = dbquery("INSERT INTO ".$db_prefix."admin_panels (panel_id, panel_name, panel_order, panel_side, panel_file, panel_display) VALUES ('1', 'Admin Members', '2', '1', 'promembers.php', '1')");
	$result = dbquery("INSERT INTO ".$db_prefix."admin_panels (panel_id, panel_name, panel_order, panel_side, panel_file, panel_display) VALUES ('2', 'Admin Messages', '2', '2', 'promessages.php', '1')");
	...
	$result = dbquery("INSERT INTO ".$db_prefix."admin_options (option_name, option_value) VALUES ('admin_style', 'modern')");

	$result = dbquery("INSERT INTO ".$db_prefix."admin (admin_rights, admin_image, admin_title, admin_link, admin_page) VALUES ('AO', 'admin_option.gif', 'Administrator Options', 'proadmin/prooptions.php', '4')");							
...
if (isset($_POST['step']) && $_POST['step'] == "6") {
	...
	if ($error == "") {
		if ($rows == 0) {
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('theme', 'Cveu-Cube')");
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('version', '7.02.07 DE')");
			...
			$result = dbquery("INSERT INTO ".$db_prefix."panels (panel_name, panel_filename, panel_content, panel_side, panel_order, panel_type, panel_access, panel_display, panel_status, panel_url_list) VALUES ('".$locale['166']."', 'user_info_panel', '', '1', 1, 'file', '0', '0', '0', '')");
			$result = dbquery("INSERT INTO ".$db_prefix."panels (panel_name, panel_filename, panel_content, panel_side, panel_order, panel_type, panel_access, panel_display, panel_status, panel_url_list) VALUES ('".$locale['167']."', 'member_poll_panel', '', '1', '2', 'file', '0', '0', '0', '')");
		...
		$enabled_languages = explode('.', $settings['enabled_languages']);
			...
			for ($i = 0; $i < sizeof($enabled_languages); $i++) {
				...
				$result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['131']."', 'articles/articles.php', '0', '2', '0', '2', '".$enabled_languages[$i]."')");
				$result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['132']."', 'downloads/downloads.php', '0', '2', '0', '3', '".$enabled_languages[$i]."')");
				$result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['133']."', 'faq/faq.php', '0', '1', '0', '4', '".$enabled_languages[$i]."')");
				...
				$result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['137']."', 'weblinks/weblinks.php', '0', '2', '0', '6', '".$enabled_languages[$i]."')");
				$result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['135']."', 'infusions/vaContact/formulare/kontakt.php', '0', '1', '0', '8', '".$enabled_languages[$i]."')");
				$result = dbquery("INSERT INTO ".$db_prefix."site_links (link_name, link_url, link_visibility, link_position, link_window, link_order, link_language) VALUES ('".$locale['138']."', 'photogallery/photogallery.php', '0', '1', '0', '9', '".$enabled_languages[$i]."')");
