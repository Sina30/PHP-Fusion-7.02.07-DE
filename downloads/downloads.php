...
// download the file Only Members Can Download Added by Craig - http://www.phpfusionmods.co.uk
if (isset($_GET['file_id']) && isnum($_GET['file_id']) && iMEMBER) {
...
$dl_stats .= "</td>\n</tr>\n</table>\n";
   ...
   echo "<a href='".BASEDIR."downloads/downloads.php?download_cat=".$data['download_cat']."&amp;download_id=".$data['download_id']."'>\n";
   ...
   // opentable closetable Added to Downloads Stats by Craig - http://www.phpfusionmods.co.uk
...
if (isset($_GET['download_id']) && isnum($_GET['download_id'])) {
   ...
   echo download_license_colorbox();
      echo "</div>";
   if(iMEMBER) {
   echo"<a  class='download-it' ><div class='dl-itb'>\n";
   ...
   // Ajax Star Ratings Added by Craig - http://www.phpfusionmods.co.uk
