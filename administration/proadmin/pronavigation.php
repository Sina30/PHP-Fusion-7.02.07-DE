...
echo '		<div><ul id="navigation" style="list-style-type: none; margin: 0px; padding: 0px;" class="menu noaccordion">';
				echo '<li><a href="'.ADMIN.'dashboard.php'.$aidlink.'" style="cursor:pointer;" onclick="window.open (\''.ADMIN.'dashboard.php'.$aidlink.'\',\'_self\',false);">';
					echo '<div style="height:36px;width:100%;clear:both;background-image:url('.THEMES.'templates/images/admin/left-content-bg.png);background-repeat: repeat-x;margin: 0px;">';	
						echo '<div style="width: auto;margin: 0px 7px 0px 7px;line-height:300%">';		
							echo '<img src="'.THEMES.'templates/images/admin/dashboard.gif" border="0" /> &nbsp;&nbsp;'.$locale['pro_1007'].'';		
						echo '</div>';		
					echo '</div>';
				echo '</a></li>';
			echo '</ul></div>';
echo '			<div><ul id="navigation" style="list-style-type: none; margin: 0px; padding: 0px;" class="menu noaccordion">';
				echo '<li><a style="cursor:pointer;" onclick="cookieyaz(1);">';
					echo '<div style="height:36px;width:100%;clear:both;background-image:url('.THEMES.'templates/images/admin/left-content-bg.png);background-repeat: repeat-x;margin: 0px;">';
						echo '<div style="width: auto;margin: 0px 7px 0px 7px;line-height:300%">';	
							echo '<img src="'.THEMES.'templates/images/admin/content.gif" border="0" /> &nbsp;&nbsp;'.$locale['pro_1002'].'';		
						echo '</div>';		
					echo '</div>';
				echo '</a>';
...
echo '	</ul></li>';
			echo '</ul></div>';
			echo '<div><ul id="navigation" style="list-style-type: none; margin: 0px; padding: 0px;" class="menu noaccordion">';
				echo '<li><a style="cursor:pointer;" onclick="cookieyaz(2);">';
					echo '<div style="height:36px;width:100%;clear:both;background-image:url('.THEMES.'templates/images/admin/left-content-bg.png);background-repeat: repeat-x;margin: 0px;">';
						echo '<div style="width: auto;margin: 0px 7px 0px 7px;line-height:300%">';		
							echo '<img src="'.THEMES.'templates/images/admin/user.gif" border="0" /> &nbsp;&nbsp;'.$locale['pro_1003'].'';		
						echo '</div>';		
					echo '</div>';
				echo '</a>';
...
echo '	</ul></li>';	
			echo '</ul></div>';
			echo '<div><ul id="navigation" style="list-style-type: none; margin: 0px; padding: 0px;" class="menu noaccordion">';
				echo '<li><a style="cursor:pointer;" onclick="cookieyaz(3);">';
					echo '<div style="height:36px;width:100%;clear:both;background-image:url('.THEMES.'templates/images/admin/left-content-bg.png);background-repeat: repeat-x;margin: 0px;">';		
						echo '<div style="width: auto;margin: 0px 7px 0px 7px;line-height:300%">';		
							echo '<img src="'.THEMES.'templates/images/admin/system.gif" border="0" /> &nbsp;&nbsp;'.$locale['pro_1004'].'';		
						echo '</div>';		
					echo '</div>';
				echo '</a>';
...
echo '	</ul></li>';
			echo '</ul></div>';
			echo '<div><ul id="navigation" style="list-style-type: none; margin: 0px; padding: 0px;" class="menu noaccordion">';
				echo '<li><a style="cursor:pointer;" onclick="cookieyaz(4);">';
					echo '<div style="height:36px;width:100%;clear:both;background-image:url('.THEMES.'templates/images/admin/left-content-bg.png);background-repeat: repeat-x;margin: 0px;">';		
						echo '<div style="width: auto;margin: 0px 7px 0px 7px;line-height:300%">';		
							echo '<img src="'.THEMES.'templates/images/admin/setting.gif" border="0" /> &nbsp;&nbsp;'.$locale['pro_1005'].'';		
						echo '</div>';		
					echo '</div>';
				echo '</a>';
...
echo '	</ul></li>';	
			echo '</ul></div>';
			echo '<div><ul id="navigation" style="list-style-type: none; margin: 0px; padding: 0px;" class="menu noaccordion">';
				echo '<li><a style="cursor:pointer;" onclick="cookieyaz(5);">';
					echo '<div style="height:36px;width:100%;clear:both;background-image:url('.THEMES.'templates/images/admin/left-content-bg.png);background-repeat: repeat-x;margin: 0px;">';		
						echo '<div style="width: auto;margin: 0px 7px 0px 7px;line-height:300%">';		
							echo '<img src="'.THEMES.'templates/images/admin/infustion.gif" border="0" /> &nbsp;&nbsp;'.$locale['pro_1006'].'';	
						echo '</div>';		
					echo '</div>';
				echo '</a>';
