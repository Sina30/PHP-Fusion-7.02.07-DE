...
echo "<form name='settingsform' method='post' action='".FUSION_SELF.$aidlink."'>\n";
		...
		echo "<tr><td class='tbl'>".$locale['551']."</br><select name='enable_registration' class='textbox'>
		<option value='1'".($settings2['enable_registration'] == "1" ? " selected='selected'" : "").">".$locale['518']."</option>
		<option value='0'".($settings2['enable_registration'] == "0" ? " selected='selected'" : "").">".$locale['519']."</option></select></td>";
		
		echo "<td class='tbl'>".$locale['552']."</br><select name='email_verification' class='textbox'>
		<option value='1'".($settings2['email_verification'] == "1" ? " selected='selected'" : "").">".$locale['518']."</option>
		<option value='0'".($settings2['email_verification'] == "0" ? " selected='selected'" : "").">".$locale['519']."</option></select></br></td></tr>";
		
		echo "<tr><td class='tbl'>".$locale['557']."</br><select name='admin_activation' class='textbox'>
		<option value='1'".($settings2['admin_activation'] == "1" ? " selected='selected'" : "").">".$locale['518']."</option>
		<option value='0'".($settings2['admin_activation'] == "0" ? " selected='selected'" : "").">".$locale['519']."</option></td>";
		
		echo "<td class='tbl'>".$locale['553']."</br><select name='display_validation' class='textbox'>
		<option value='1'".($settings2['display_validation'] == "1" ? " selected='selected'" : "").">".$locale['518']."</option>
		<option value='0'".($settings2['display_validation'] == "0" ? " selected='selected'" : "").">".$locale['519']."</option></select></td></tr>";
		
		echo "<tr><td class='tbl'>".$locale['558']."</br><select name='enable_terms' class='textbox'>
		<option value='1'".($settings2['enable_terms'] == "1" ? " selected='selected'" : "").">".$locale['518']."</option>
		<option value='0'".($settings2['enable_terms'] == "0" ? " selected='selected'" : "").">".$locale['519']."</option></select></td>";
		
		echo "<td class='tbl'>".$locale['559']."</br>";
		echo "<textarea name='license_agreement' cols='50' rows='10' class='textbox' style='width:320px'>".phpentities(stripslashes($settings2['license_agreement']))."</textarea></br>\n";
		if (!$settings['tinymce_enabled']) {
